...
namespace Fistnet.Genepool.App
{
    ...
    public partial class MainForm : Form
    {
        ...
        public static string Configuration(SimulationRunOptions options) => "Random start " + options.InitialPopulationPercent + "%  ·  Seed " + options.Seed + "  ·  Food " + options.InitialCellFood + "/10  ·  Regrowth " + options.FoodRegrowthPerAge + "/cycle  ·  Reserves " + options.InitialOrganismFood + "/10  ·  " +
