...
namespace Fistnet.Genepool.App
{
    ...
    public sealed class NewSimulationDialog : Form
    {
        ...
        private readonly ComboBox Learning, Vitality, Predation, Preset;
        ...
        public NewSimulationDialog(SimulationRunOptions current = null)
        {
            ...
            var layout = new TableLayoutPanel { Dock = DockStyle.Top, AutoSize = true, AutoSizeMode = AutoSizeMode.GrowAndShrink, Padding = new Padding(22), ColumnCount = 2, RowCount = 13 };
            layout.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 53)); layout.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 47));
            for (int i = 0; i < 13; i++) layout.RowStyles.Add(new RowStyle(SizeType.Absolute, i == 0 ? 53 : i == 1 ? 51 : i == 8 ? 62 : i == 12 ? 77 : 36));
            ...
            var explanation = TextLabel("Placement and DNA stay random. Settings apply only to the new run; no mid-run rescue or balancing is added.");
            ...
            var presetsLabel = TextLabel("Single-policy comparisons", true); layout.Controls.Add(presetsLabel, 0, 7);
            Preset = Combo(new[] { "Current settings", "Random defaults", "Exploratory learning only", "Capped health only", "Reserve-transfer predation only" }); layout.Controls.Add(Preset, 1, 7);
            ...
            layout.Controls.Add(advanced, 0, 8); layout.SetColumnSpan(advanced, 2);
            ...
            AddRow(9, "Learning", Learning); AddRow(10, "Vitality", Vitality); AddRow(11, "Predation", Predation);
            ...
            layout.Controls.Add(units, 0, 12); layout.SetColumnSpan(units, 2);
